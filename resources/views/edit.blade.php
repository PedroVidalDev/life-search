        ...
        <div class="container-create">
            <form action="/projects/update/{{ $project->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="ajustador-create">
                    ...
                    <input class="title" type="text" name="title" placeholder="{{ $project->title }}">
                </div>

                <div class="ajustador-create">
                    <label> Descricao do Projeto: </label>
                    <textarea class="description" type="text" name="description" placeholder="{{ $project->description }}"></textarea>
                </div>
                ...
                <div class="ajustador-create-image">
                    <div class="ajustador-image">
                        <label for="image"> Imagem do Projeto: </label>
                        <input class="image" type="file" id="image" name="image">
                    </div>

                    <div class="ajustador-image-antes">
                        <img src="/img/projects/{{ $project->image }}" alt="{{$project->title}}" width="50px" style="margin-right: 50px;">
                    </div>
                </div>

                <div class="ajustador-create">
                    <label> Link do Repositorio do Projeto: </label>
                    <input class="repositorio" type="text" name="repository" placeholder="{{ $project->repository }}">
                </div>

                <div class="ajustador-create">
                    <input class="submit" type="submit" value="Finalizar edicao">
                </div>
            </form>
